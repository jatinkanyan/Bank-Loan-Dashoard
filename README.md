...
* **Approval Ratios:** Percentage of applications converted into funded loans.

### 3. Temporal & Categorical Trends
* **Monthly Trends:** Visualizing month-over-month growth.
* **Regional Analysis:** Breakdown of lending activity by state/region.
* **Loan Term Analysis:** Comparison of 36-month vs. 60-month loan performance.
